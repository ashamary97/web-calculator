...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4"><img src="images/image2.png" class="img-thumbnail" alt="..." height="350" width="350"> </div>
            ...
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4" style="font-size: larger;">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td><button onclick="mybuttonclick()" class="btn btn-success"> SUBTRACT</button></td>
                    </tr>
                    <tr>
                        <td>Result</td>
                        <td><p id="result"></p></td>
